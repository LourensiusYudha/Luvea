...
const advantages = [
  { image: '/images/kelembutan_serat.png', title: 'Kelembutan Serat', desc: 'Serat Rayon Premium Grade A yang sangat halus memanjakan kulit. Tidak kasar, tidak gatal, nyaman dipakai sepanjang malam.' },
