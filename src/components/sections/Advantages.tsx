...
const advantages = [
  { image: '/images/kelembutan_serat.png', title: 'Kelembutan Serat', desc: 'Serat rayon grade A yang sangat halus memanjakan kulit. Tidak kasar, tidak gatal, nyaman dipakai sepanjang malam.' },
  ...
  { image: '/images/kancing_premium.png', title: 'Kancing Berkualitas', desc: 'Detail kancing kuat yang tidak mudah lepas. Desain yang memudahkan saat menyusui.' },
